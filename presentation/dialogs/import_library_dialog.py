...
class MediaLibraryView(QWidget):
    ...
    def _setup_ui(self) -> None:
        ...
        # Botão Retomar
        self.resume_btn = QPushButton("▶️ Retomar Importação")
        ...
        try:
            ...
            for row, media in enumerate(media_files):
                ...
                status_map = {
                    ...
                    ProcessingStatus.PROCESSING: "⚙️ Processando",
                    ProcessingStatus.FAILED: "✗ Erro",
                    ProcessingStatus.SKIPPED: "⊘ Ignorado",
                }
                status_text = status_map.get(media.processing_info.status, media.processing_info.status.value)
